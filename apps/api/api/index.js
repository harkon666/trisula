...
function construct(client, config2 = {}) {
  ...
  const session = new PostgresJsSession(client, dialect, schema, { logger: logger2, cache: config2.cache });
...
var db = new Proxy({}, {
  get(target, prop) {
    if (!_db) {
      console.log("\u{1F4E6} Initializing database connection (Lazy)...");
