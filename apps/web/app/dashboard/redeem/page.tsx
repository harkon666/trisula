...
import { Redeem, NasabahNavbar, DailyCheckInModal } from "@/src/components/organisms";
    ...
    return (
        <RoleGuard allowedRoles={["nasabah"]}>
            <div className="min-h-screen bg-charcoal-deep text-white relative overflow-hidden">
                ...
                <DailyCheckInModal>
                    <div className="max-w-6xl mx-auto relative z-10 px-6 pt-28 pb-16">
                        <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
                            <div>
                                <Button variant="ghost" size="sm" onClick={() => router.push('/dashboard/nasabah')} className="mb-4 -ml-4 text-zinc-500 hover:text-white">
                                    ← Kembali ke Dashboard
                                </Button>
                                <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight">
                                    Reward <span className="bg-gradient-to-r from-gold-metallic to-gold-light bg-clip-text text-transparent">Catalog</span>
                                </h1>
                                <p className="text-zinc-500 font-medium mt-2">Tukarkan poin Anda dengan pengalaman eksklusif.</p>
                            </div>
                            <Card variant="solid" className="bg-gold-metallic/5 border-gold-metallic/20 p-6 flex flex-col items-end backdrop-blur-xl">
                                <p className="text-[10px] text-gold-metallic/70 uppercase tracking-widest font-black mb-1">Available Points</p>
                                <p className="text-4xl font-black text-gold-metallic">
                                            ...
                                            <Redeem>
                                                <div className="mt-auto pt-6 border-t border-white/5 flex flex-col gap-4">
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() => {/* Redirection or local logic */ }}
                                                    >
                                                        Redeem Reward
                                                    </Button>
                                                </div>
                                                <Redeem.Content userPoints={userPoints} view="confirm" />
                                            </Redeem>
                                        </div>
                                    </Card>
                                ))
                ...
                <Redeem.Overlay
                    ...
                    isRedeemPending={false} // This page handles its own mutation state differently or needs closer integration
                    onConfirm={() => { }} // Needs integration with the local confirm logic if we keep this page
                    view="confirm"
                />
            </div>
        </RoleGuard>
