    ...
    <div className="min-h-screen bg-zinc-950 text-white selection:bg-amber-500/30">
      ...
      <nav className="fixed top-0 w-full z-50 bg-zinc-950/50 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="scale-90 md:scale-100 flex items-center">
            <ConnectWallet transparent />
          </div>
        </div>
      </nav>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                title: "Connect & Sync",
                desc: "Join easily using your digital wallet. No complex setup—just one click to start your journey.",
                icon: (
              ...
              {
                title: "View Insights",
                desc: "Get an instant overview of your total wealth, combining all your assets in one high-premium dashboard.",
                icon: (
              ...
              },
              {
                ...
                desc: "Accumulate points automatically based on your holdings. The more you hold, the more you earn.",
                icon: (
              ...
              },
              {
                ...
                desc: "Spend your earned points on exclusive lifestyle benefits and premium digital assets.",
                icon: (
            ...
            {[
              {
                ...
                desc: "Monitor your entire financial portfolio, from traditional fiat accounts to crypto assets, all in one premium interface.",
                icon: (
                  <svg className="w-8 h-8 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              },
              {
                ...
                desc: "Earn points instantly from referrals and receive daily point yields based on your total assets (AUM) and loyalty tier.",
                icon: (
                  <svg className="w-8 h-8 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              },
              {
                ...
                desc: "Built on Base Network with institutional-grade security and seamless account management.",
                icon: (
                  <svg className="w-8 h-8 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
