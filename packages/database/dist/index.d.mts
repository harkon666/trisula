...
declare const pointsLedger: drizzle_orm_pg_core.PgTableWithColumns<{
    ...
    columns: {
        ...
        source: drizzle_orm_pg_core.PgColumn<{
            ...
            dataType: "string";
            columnType: "PgEnumColumn";
            data: "admin" | "system" | "redeem" | "yield" | "transaction";
            driverParam: string;
            notNull: true;
            hasDefault: false;
            isPrimaryKey: false;
            isAutoincrement: false;
            hasRuntimeDefault: false;
            enumValues: ["system", "admin", "redeem", "yield", "transaction"];
            baseColumn: never;
            identity: undefined;
            generated: undefined;
        }, {}, {}>;
...
declare const fiatAccounts: drizzle_orm_pg_core.PgTableWithColumns<{
    name: "fiat_accounts";
    schema: undefined;
    columns: {
        id: drizzle_orm_pg_core.PgColumn<{
...
declare const loyaltyTiers: drizzle_orm_pg_core.PgTableWithColumns<{
    name: "loyalty_tiers";
    schema: undefined;
    columns: {
        id: drizzle_orm_pg_core.PgColumn<{
        ...
        minAum: drizzle_orm_pg_core.PgColumn<{
            name: "min_aum";
            tableName: "loyalty_tiers";
            dataType: "string";
            columnType: "PgNumeric";
        ...
        yieldMultiplier: drizzle_orm_pg_core.PgColumn<{
...
declare const dailyYieldLogs: drizzle_orm_pg_core.PgTableWithColumns<{
    name: "daily_yield_logs";
    schema: undefined;
    columns: {
        id: drizzle_orm_pg_core.PgColumn<{
            name: "id";
            tableName: "daily_yield_logs";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
        ...
        totalAum: drizzle_orm_pg_core.PgColumn<{
            name: "total_aum";
            tableName: "daily_yield_logs";
            dataType: "string";
            columnType: "PgNumeric";
        ...
        yieldEarned: drizzle_orm_pg_core.PgColumn<{
            name: "yield_earned";
            tableName: "daily_yield_logs";
            dataType: "number";
            columnType: "PgInteger";
        ...
        tierAtTime: drizzle_orm_pg_core.PgColumn<{
            name: "tier_at_time";
            tableName: "daily_yield_logs";
            dataType: "string";
            columnType: "PgVarchar";
...
declare const schema_dailyYieldLogs: typeof dailyYieldLogs;
declare const schema_fiatAccounts: typeof fiatAccounts;
declare const schema_loyaltyTiers: typeof loyaltyTiers;
